...
//     navigate("/employeeaddstockpage"); // jis route pe jaana hai
//   };
...
//             className="bg-[#04b6d6] hover:bg-[#039bb6] text-white font-medium px-4 py-2 rounded w-full md:w-auto whitespace-nowrap"
//           >
//             Add Stock
//           </button>
...
//                   {/* <td className="px-2 py-2 border">{item.addBy}</td> */}
