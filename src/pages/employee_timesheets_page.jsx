...
//   const email = localStorage.getItem("employeeEmail");
//   const today = new Date().toISOString().split("T")[0];
//   const storedDate = localStorage.getItem(`loginDate_${email}`);
//   const storedTime = localStorage.getItem(`employeeLoginTime_${email}`);

//   if (storedDate === today && storedTime) {
//     const [hour, minute] = storedTime.split(":");
//     const cleanTime = `${hour}:${minute}`;
//     setFormData((prev) => ({ ...prev, login: cleanTime }));
//   } else {
//     const now = new Date();
//     const formattedTime = `${String(now.getHours()).padStart(2, "0")}:${String(now.getMinutes()).padStart(2, "0")}`;
//     localStorage.setItem(`employeeLoginTime_${email}`, formattedTime);
//     localStorage.setItem(`loginDate_${email}`, today);
//     setFormData((prev) => ({ ...prev, login: formattedTime }));
//   }
// }, []);
...
//   const profileImage = employee?.profileImage || "https://img.freepik.com/premium-vector/vector-flat-illustration-grayscale-avatar-user-profile-person-icon-gender-neutral-silhouette-profile-picture-suitable-social-media-profiles-icons-screensavers-as-templatex9xa_719432-2210.jpg?semt=ais_hybrid&w=740";
...
//           </div>
//           <h2 className="text-2xl font-bold">Welcome, {employee?.name || "Employee"}</h2>
//           <p className="text-sm text-gray-600 mt-1">Designation: {employee?.designation || "N/A"}</p>
//           <p className="text-sm text-gray-600">projects: {employee?.project || "N/A"}</p>
//           <p className="text-sm text-gray-600">Email: {employee?.email || "N/A"}</p>
//           <p className="text-sm text-gray-600">Employee ID: {employee?.employeeId || employee?.id || "N/A"}</p>
//         </div>
...
//           {/* Task Table */}
//           <div className="bg-white border-l-4 border-[#32A9C7] p-6 rounded-2xl shadow-md overflow-auto">
//             <h3 className="text-xl font-semibold text-[#32A9C7] mb-4">Submitted Tasks</h3>
//             <table className="w-full text-sm border">
//               <thead className="bg-[#5ed9de] text-gray-800">
//                 <tr>
//                   <th className="p-3 border">Date</th>
...
//                       {/* <td className="p-3 border whitespace-pre-wrap break-words">{entry.task}</td> */}
...
//                       <td className="p-3 border">{entry.attachment ? (
//            <a
//             href={`http://localhost:3004/uploads/${entry.attachment}`}
//             target="_blank"
//             rel="noopener noreferrer"
...
//     <div className="flex justify-center items-center h-full">
//       <span className="text-2xl">-</span>
//     </div> // show "-" if empty or only whitespace
//   ) : entry.suggestions.split(" ").length > 10 ? (
//     <div className="flex items-center space-x-2">
//       <span>{entry.suggestions.split(" ").slice(0, 6).join(" ")}...</span> {/* show first 6 words */}
//       <button
//         onClick={() => openModal(entry.suggestions)} // open popup with full suggestion
//         className="text-blue-600 hover:text-blue-800"
//       >
//         <FcInfo size={18} />
//       </button>
//     </div>
//   ) : (
//     <span>{entry.suggestions}</span> // show full suggestion
//   )}
// </td>



//                       {/* <td className="p-3 border whitespace-pre-wrap break-words">{entry.next_day_task}</td> */}
...
//               <h2 className="text-lg font-bold mb-4 text-gray-800">All info</h2>
//               <p className="text-gray-700 whitespace-pre-wrap">{[selectedTask, selectedSuggestions,selectedNextDayTask ]}</p>
//               <button
//                 onClick={closeModal}
