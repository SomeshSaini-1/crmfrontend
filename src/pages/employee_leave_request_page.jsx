...
<div className="mt-4 relative">
  ...
  <div className="relative">
    <select
      ...
      className="mt-1 w-full px-3 sm:px-4 py-2 pr-8 border rounded-lg text-sm sm:text-base appearance-none bg-white"
    >
      <option value="Casual Leave">Casual Leave</option>
      <option value="Sick Leave">Sick Leave</option>
    </select>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-2">
        <div className="relative bg-white rounded-2xl shadow-2xl p-4 sm:p-6 max-w-lg w-full">
          ...
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Full Description</h2>
          </div>
